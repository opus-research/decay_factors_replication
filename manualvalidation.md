...
The spreadsheet that was used for the manual validation can be downloaded **[here](https://github.com/opus-research/decay_factors_replication/blob/paper/replication_package/manual_validation/manual_validation.xlsx?raw=true)**. 